  ...
  const teamGroups: TeamGroup[] = [
    {
      ...
      enName: "Management",
      members: [
        { name: "许德淋", roleTitle: "队长", image: "/images/team/temp.png" },
        { name: "马晓阳", roleTitle: "底盘总监", image: "/images/team/temp.png" },
        { name: "陈君灏", roleTitle: "车身总监", image: "/images/team/temp.png" },
        { name: "冯俞霖", roleTitle: "电气总监", image: "/images/team/temp.png" },
        { name: "郭祺", roleTitle: "运营总监", image: "/images/team/temp.png" },
        { name: "霍文祺", roleTitle: "车队经理", image: "/images/team/temp.png" },
        { name: "李浩然", roleTitle: "运动部长", image: "/images/team/temp.png" },
      ]
    },
    {
      name: "运营部",
      enName: "Operations",
      members: [
        { name: "张城铭", roleTitle: "商业组组长", image: "/images/team/temp.png" },
        { name: "陶劲安", roleTitle: "运营组组员", image: "/images/team/temp.png" },
      ]
    },
    {
      name: "底盘部",
      enName: "Mechanic",
      members: [
        { name: "姜鸿元", subgroup: "悬架转向组", isLeader: true, image: "/images/team/temp.png" },
        { name: "郭家旭", subgroup: "悬架转向组", image: "/images/team/temp.png" },
        { name: "陈冰", subgroup: "悬架转向组", image: "/images/team/temp.png" },
        { name: "邹梓泓", subgroup: "悬架转向组", image: "/images/team/temp.png" },
        { name: "邱国烨", subgroup: "悬架转向组", image: "/images/team/temp.png" },
        { name: "杨杰文", subgroup: "传动组", isLeader: true, image: "/images/team/temp.png" },
        { name: "肖维", subgroup: "传动组", image: "/images/team/temp.png" },
        { name: "何博宇", subgroup: "传动组", image: "/images/team/temp.png" },
        { name: "彭绍阳", subgroup: "制动组", isLeader: true, image: "/images/team/temp.png" },
        { name: "邓济佳", subgroup: "制动组", image: "/images/team/temp.png" },
        { name: "胡铭彦", subgroup: "动力学算法组", isLeader: true, image: "/images/team/temp.png" },
        { name: "江泽伟", subgroup: "动力学算法组", image: "/images/team/temp.png" },
      ]
    },
    {
      name: "车身部",
      ...
      members: [
        { name: "王振宇", subgroup: "单体壳组", isLeader: true, image: "/images/team/temp.png" },
        { name: "刘沂轩", subgroup: "单体壳组", image: "/images/team/temp.png" },
        { name: "彭成君", subgroup: "空套组", isLeader: true, image: "/images/team/temp.png" },
        { name: "杨贯弘", subgroup: "空套组", image: "/images/team/temp.png" },
        { name: "徐瀚文", subgroup: "空套组", image: "/images/team/temp.png" },
        { name: "黎梓浩", subgroup: "空套组", image: "/images/team/temp.png" },
        { name: "汤帅", subgroup: "冷却组", isLeader: true, image: "/images/team/temp.png" },
        { name: "劳乔煜", subgroup: "冷却组", image: "/images/team/temp.png" },
      ]
    },
    {
      name: "电气部",
      enName: "Electronics",
      members: [
        { name: "黄熙文", subgroup: "电池组", isLeader: true, image: "/images/team/temp.png" },
        { name: "曾潮锋", subgroup: "电池组", image: "/images/team/temp.png" },
        { name: "陈天柚", subgroup: "电池组", image: "/images/team/temp.png" },
        { name: "杨辉利", subgroup: "电池组", image: "/images/team/temp.png" },
        { name: "李魏朝阳", subgroup: "电子系统组", image: "/images/team/temp.png" },
        { name: "连梓键", subgroup: "电子系统组", image: "/images/team/temp.png" },
        { name: "邱贤辉", subgroup: "电机组", isLeader: true, image: "/images/team/temp.png" },
      ]
    }
  ];
